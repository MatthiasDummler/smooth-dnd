...
export declare type OnStyleContainerCallback = Callback<{
    property: string;
    value: string | null;
    element: HTMLElement;
}>;
export declare type CreateGhostElement = (wrapperElement: HTMLElement, position: Position, container: IContainer, cursor: string) => HTMLElement;
